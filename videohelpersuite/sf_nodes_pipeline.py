    ...
    def INPUT_TYPES(cls):
        return {
            ...
            "optional": {
                ...
                "height_mode": (["motion_preset", "override", "multiply"], {
                    "default": "motion_preset",
                    "tooltip": "motion_preset 保留DepthFlow动画高度；override/multiply用于强制自定义高度",
                }),
                "depth_height": ("FLOAT", {
                    "default": 0.2, "min": -2.0, "max": 2.0, "step": 0.01,
                    "tooltip": "DepthState.height；height_mode=override/multiply 时生效",
                }),
                "focus_depth": ("FLOAT", {"default": 0.0, "min": -2.0, "max": 1.0, "step": 0.01}),
                ...
                "vignette_intensity": ("FLOAT", {"default": 0.0, "min": 0.0, "max": 1.0, "step": 0.01}),
                "vignette_decay": ("FLOAT", {"default": 20.0, "min": 0.0, "max": 100.0, "step": 1.0}),
                "lens_intensity": ("FLOAT", {"default": 0.0, "min": 0.0, "max": 2.0, "step": 0.01}),
                "lens_decay": ("FLOAT", {"default": 0.4, "min": 0.0, "max": 1.0, "step": 0.01}),
                "lens_quality": ("INT", {"default": 30, "min": 0, "max": 60}),
                "blur_intensity": ("FLOAT", {"default": 0.0, "min": 0.0, "max": 2.0, "step": 0.01}),
